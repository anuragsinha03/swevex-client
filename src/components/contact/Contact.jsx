            ...
            <section>
                ...
                <div>
                    ...
                    <div className="flex justify-center ">
                        <span className="services-border | relative font-medium text-2xl my-4">GET IN TOUCH!</span> 
                    </div>
                </div>
                <div className="max-width-container my-6 text-[10px] border-l-[15px] border-[#0894DE] pl-2 leading-tight font-extralight md:text-[24px] md:border-l-[30px]">
                    <p className="">At SwevexTECH, our mission is to drive business and bridge the divide between offshore locations by creating opportunity for profit without compromising on quality or amount of deliverables. </p>
                </div>
                ...
                <div className="max-width-container flex flex-col gap-2 my-6 text-[10px] border-l-[15px] border-black pl-2 leading-tight bg-[#d9d9d9] p-4 font-extralight md:text-[24px] md:border-l-[30px]">
                    <div className="flex gap-2">
                        ...
                        <div>
                            <p className="font-medium">SWEVEX TECH SOLUTION (OPC) PRIVATE LIMITED</p>
                ...
                <div className="max-width-container sm:h-[200px]">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3662.6605869875902!2d85.34385490615993!3d23.364308163690637!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4157ac4ffb5e5%3A0xaa7906d2dcb8730e!2sSwevex%20Tech%20Solution%20Pvt%20Ltd.!5e0!3m2!1sen!2sin!4v1675015407805!5m2!1sen!2sin" width="100%" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title='map' />
                </div>
